# Generated by Django 3.1.1 on 2021-09-07 01:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(error_messages={'unique': 'User already taken'}, max_length=254, unique=True, verbose_name='email address')),
                ('phone_number', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message='Phone number must be entered in the format: +9999999999 up to 15 digits allowed.', regex='\\+?1?\\d{9, 15}$')], verbose_name='phone number')),
